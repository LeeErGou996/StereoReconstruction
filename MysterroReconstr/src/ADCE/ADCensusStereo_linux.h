...
* Describe	: header of ad-census stereo class (Linux version)
*/
#pragma once
...
public:
	...
	/**
	* \brief 初始化，分配一些内存预分配、参数预设置等
	* \param width		输入，影像宽度
	* \param height		输入，影像高度
	...
	*/
	...
	/**
	* \brief 执行匹配
	* \param img_left	输入，左影像数据指针，3通道彩色图像
	* \param img_right	输入，右影像数据指针，3通道彩色图像
	* \param disp_left	输出，左影像视差图指针，预先分配影像尺寸大小的内存空间
	*/
